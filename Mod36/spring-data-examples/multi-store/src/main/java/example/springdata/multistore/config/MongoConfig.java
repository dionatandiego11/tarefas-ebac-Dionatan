...
public class MongoConfig {
    ...
    public MongoClient mongo() throws Exception {
		...
		final ConnectionString connectionString = new ConnectionString("mongodb://admin:123@127.0.0.1:27017/ebac?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false");
